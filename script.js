...
function getLiveSignal() {
    ...
    xButtonWindow.document.write(`
        ...
        <body>
            <h2>🚀 2.8X Signal Ready!</h2>
            <button class="x-btn">2.8X</button>
        </body>
        </html>
    `);

    // Close 2.8X window after 10 seconds and open hacker screen
    setTimeout(() => {
        xButtonWindow.close();
